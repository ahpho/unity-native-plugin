...
#-DCMAKE_TOOLCHAIN_FILE=/home/kuang/AndroidSdk/ndk/android-ndk-r21e/build/cmake/android.toolchain.cmake
...
cmake -DANDROID_ABI=armeabi-v7a -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_NATIVE_API_LEVEL=android-24 ../
cd ..
...
cmake -DANDROID_ABI=arm64-v8a -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_NATIVE_API_LEVEL=android-24 ../
cd ..
...
cmake -DANDROID_ABI=x86 -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_NATIVE_API_LEVEL=android-24 ../
cd ..
...
cmake -DANDROID_ABI=x86_64 -DCMAKE_TOOLCHAIN_FILE=$ANDROID_NDK/build/cmake/android.toolchain.cmake -DANDROID_NATIVE_API_LEVEL=android-24 ../
cd ..
